...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded-sm">
            ...
            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>&funcao=novo">Alunos</a>
            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>&funcao=novo">Responsaveis</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded-sm">
            <a class="collapse-item" href="index.php?pag=<?php echo $menu7 ?>&funcao=novo">Turmas</a>
